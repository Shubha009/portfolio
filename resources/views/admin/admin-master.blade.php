...
{{ asset('backend/') }}
  ...
  <link href="{{ asset('backend/assets/css/font-awesome_fonts') }}" rel="stylesheet" />
        ...
        <div class="content-wrapper">
          <div class="content">						 
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2020-2022</span> Copyright
                <a
                  class="text-primary"
                  href="{{ url('https://www.shubhamandal.com/') }}"
                  target="_blank"
                  >Shubha Mandal</a
                >.
              </p>
...
<script src="{{ asset('backend/assets/js/font-awesome.min.js') }}"></script>
